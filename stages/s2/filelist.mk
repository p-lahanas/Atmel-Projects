...
LIBSRCS += $(MYLIB_PATH)/s4587423_reg_lta1000g.c $(MYLIB_PATH)/s4587423_reg_joystick.c $(MYLIB_PATH)/s4587423_reg_iss.c $(MYLIB_PATH)/s4587423_reg_pantilt.c $(MYLIB_PATH)/s4587423_reg_pb.c